...
import com.example.demo.proxy.material.MaterialScrapDataProxy;
import lombok.Data;
...
@Erupt(
        name = "物料报废",
        dataProxy = { MaterialScrapDataProxy.class }/*,
        rowOperation = {
                @RowOperation(
                        title = "提交",
                        icon = "fa fa-check-square-o",
                        mode = RowOperation.Mode.SINGLE,
                        operationHandler = MaterialScrapOperationHandlerImpl.class,
                        // js 表达式（显示的表达式）
                ...
                @RowOperation(
                        ...
                        tpl = @Tpl(
                                ...
                                tplHandler = MaterialScrapPrintHandler.class,  //数据绑定到模板，可不设置
...
@Table(name = "t_material_scrap")
@Entity
@Data
public class MaterialScrap extends HyperModel {
        ...
        @OrderBy
        @JoinColumn(name = "material_scrap_id")
        private Set<MaterialScrapMaterialMoveOrder> materialScrapMaterialMoveOrders;
