...
@Erupt(
        name = "生产退料物料移动单明细",
        dataProxy = { ProductionBackMaterialMoveOrderDataProxy.class }
)
@Table(name = "t_production_back_material_move_order")
@Entity
@Data
public class ProductionBackMaterialMoveOrder extends BaseModel {
